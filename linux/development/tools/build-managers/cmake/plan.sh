...
pkg_shasum="7efaccde8c5a6b2968bad6ce0fe60e19b6e10701a12fce948c2bf79bac8a11e9"
...
do_install() {
	...
	# fix for interpreter
	sed -e "s,/usr/bin/env,$(pkg_interpreter_for coreutils bin/env),g" -i ${pkg_prefix}/share/cmake-4.2/Modules/Compiler/XL-Fortran/cpp
