...
$pkg_license = @("GPL-2.0")
$pkg_source = "https://github.com/git-for-windows/git/releases/download/v$pkg_version.windows.5/Git-$pkg_version.5-64-bit.tar.bz2"
$pkg_shasum = "58fdf5679db11901697d2257cd076c8cdc49d64fe641b3e64ad158f1c5bf9b8d"
$pkg_bin_dirs = @("bin")
