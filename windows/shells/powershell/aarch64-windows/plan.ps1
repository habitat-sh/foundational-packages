...
$pkg_source="https://github.com/PowerShell/PowerShell/releases/download/v$pkg_version/PowerShell-$pkg_version-win-arm64.zip"
$pkg_shasum="2D222E83A3EBCFEF268BDF4F9AD02B66698953DADC6808B8AB79AAA99BBA07D0"
$pkg_filename="powershell-$pkg_version-win-arm64.zip"
$pkg_bin_dirs=@("bin")
